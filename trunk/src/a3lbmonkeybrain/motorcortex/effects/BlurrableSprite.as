package a3lbmonkeybrain.motorcortex.effects
{
	...
	/**
	 * Default implementation for a sprite that implements <code>Blurrable</code>
	 *  
	 * @author T. Michael Keesey
	 * @see Blurrable
	 */
	public class BlurrableSprite extends Sprite implements Blurrable
	{
		/**
		...
		public function BlurrableSprite()
		{
			super();
