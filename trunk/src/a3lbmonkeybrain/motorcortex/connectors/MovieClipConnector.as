package a3lbmonkeybrain.motorcortex.connectors
{
	...
	/**
	 * A movie clip which connects two locators.
	 * 
	 * @author T. Michael Keesey
	 * @see	a3lbmonkeybrain.motorcortex.locators.Locator
	 */
	public class MovieClipConnector extends MovieClip implements DisplayObjectConnector
	{
		/**
		 * @private
		 */
		 ...
		 */
		public function MovieClipConnector()
		{
			super();
